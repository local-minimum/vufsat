...
public abstract class PrototypeModelObject implements ModelObject {
	...
	private static HashSet<Integer> modelUpdatingObjects = new HashSet<Integer>();
	private static HashSet<Integer> identifiers = new HashSet<Integer>();
	...
	private boolean setIdentifier(int id) {
